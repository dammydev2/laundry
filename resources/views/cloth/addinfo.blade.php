...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-10">
     <h3 align="center">Add a new service</h3><br />
     <div class="panel panel-default">
      <div class="panel-heading">Search Service Category</div>
      <div class="panel-body">
        ...
        <div class="col-sm-12">
          ...
          <form method="post" action="{{ url('/aditionalservice') }}" id="form1">
            {{ csrf_field() }}
       ...
       <a href="{{ url('/payment') }}" class="btn btn-danger">No Added service</a>
     </form>
     </div>
   </div>    
 </div>
...
<script>
  ...
  $(document).on("click","div.rst", function () {
   ...
   // c_price = el.data("c_price")
    ...
    tdata += "<td>"+name+"<input type='hidden' name='service[]' value='"+name+"' class='form-control qty'/></td>"
   // tdata += "<td>"+barcode+"</td>";
